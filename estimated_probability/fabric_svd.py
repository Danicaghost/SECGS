...
if __name__ == '__main__':
    ...
    workbook1 = xlsxwriter.Workbook('/DATA/xqp/my02/fabricfusion/MY02_fabric_dml_ccca.xlsx')
    workbook2 = xlsxwriter.Workbook('/DATA/xqp/my02/fabricfusion/MY02_fabric_dml_ccca_avg.xlsx')
    worksheet1 = workbook1.add_worksheet('sheet1')
    worksheet2 = workbook2.add_worksheet('sheet1')
    data = []
    data1 = []
    fileList = os.listdir('/DATA/xqp/my02/fabricfusion/1')
    fileList.sort()
    print(fileList)
    print(len(fileList))
    final_list = []
    ...
    for gh in range(10):
        ...
        DCA_fmd_VcVa_c_R1_labels = pd.read_csv("../fabric/sift_labels.csv", header=None)
        DCA_fmd_VcVa_c_R1_features1 = pd.read_csv("/DATA/xqp/my02/fabricfusion/1/" + final_list[gh], header=None)
        DCA_fmd_VcVa_c_R1_features2 = pd.read_csv("/DATA/xqp/my02/fabricfusion/2/" + final_list[gh], header=None)
        DCA_fmd_VcVa_c_R1_features3 = pd.read_csv("/DATA/xqp/my02/fabricfusion/3/" + final_list[gh], header=None)
        DCA_fmd_VcVa_c_R1_features4 = pd.read_csv("/DATA/xqp/my02/fabricfusion/4/" + final_list[gh], header=None)
        train_index1 = pd.read_csv("../fabric/label/f1_7525_train.csv", header=None)
        test_index1 = pd.read_csv("../fabric/label/f1_7525_test.csv", header=None)
        ...
        for gx in range(len(test_all)):
            ...
            for classifier, i in zip(test_classifiers, num):
                ...
                sio.savemat('/DATA/xqp/my02/fabricfusion/score/' + ux[gh] + '_' + classifier + '_' + str(gx + 1) + '_score' + '.mat',
                            dic)
                dic = {'predict': predict}
                sio.savemat('/DATA/xqp/my02/fabricfusion/score/' + 'predict_' + ux[gh] + '_' + classifier + '_' + str(
                    gx + 1) + '_score' + '.mat', dic)
