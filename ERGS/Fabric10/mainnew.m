...
avg4 = [];
aaxd = [];
tx = combntns(new_list,10);
% for g = 1:453);
txo = combntns(feature_list,10);
lenx = size(tx);
% for i=1:lenx
%     a = tx(i,1);
%     b = tx(i,2);
...
%         fused = cell(1,45);
        for i=1:lenx
            ...
            fprintf("ergs fuse %s : %s : %s : %s : %s : %s : %s : %s : %s : %s \n",a,b,c,d,e,f,g,h,z,t);
            new_feature_name = [a '_' b '_' c '_' d '_' e '_' f '_' g '_' h '_' z '_' t];
            ...
            new_feature_name_path10 = [pathx t '.mat'];
            ...
            scorepath10 = [pathy tp '_' cc_list{ox} '_' num2str(ggg) '_score.mat'];
            score1 = ['abb_score'];
            score2 = ['acc_score'];
            score3 = ['add_score'];
            score4 = ['aee_score'];
            ...
            eval([score10 '=' tp '_' cc_list{ox} '_' num2str(ggg) '_score' ';']);
           % % sort
            ...
            accuracy10 = ['sort_accuracy_' tp '_' cc_list{ox} '_' num2str(ggg)];
            cotton10 = ['precision_' tp '_' 'cotton' '_' num2str(ggg)];
            Denim10 = ['precision_' tp '_' 'Denim' '_' num2str(ggg)];
            Fleece10 = ['precision_' tp '_' 'Fleece' '_' num2str(ggg)];
            Nylon10 = ['precision_' tp '_' 'Nylon' '_' num2str(ggg)];
            Polyester10 = ['precision_' tp '_' 'Polyester' '_' num2str(ggg)];
            silk10 = ['precision_' tp '_' 'silk' '_' num2str(ggg)];
            Terrycloth10 = ['precision_' tp '_' 'Terrycloth' '_' num2str(ggg)];
            Viscose10 = ['precision_' tp '_' 'Viscose' '_' num2str(ggg)];
            Wool10 = ['precision_' tp '_' 'Wool' '_' num2str(ggg)];
            ...
            savepathsort1 = ['/DATA/xqp/my02/ergs/accuracyf10/' accuracy1 '.mat'];
...
%                save('../accuracyf/accuracy_GIST_GBDT.mat','accuracy_GIST_GBDT','precision_GIST_cotton','precision_GIST_Denim','precision_GIST_Fleece','precision_GIST_Nylon','precision_GIST_Polyester','precision_GIST_silk','precision_GIST_Terrycloth','precision_GIST_Viscose','precision_GIST_Wool');
            ...
            savepathsort2 = ['/DATA/xqp/my02/ergs/accuracyf10/' accuracy2 '.mat'];
            ...
            savepathsort3 = ['/DATA/xqp/my02/ergs/accuracyf10/' accuracy3 '.mat'];
            ...
            savepathsort4 = ['/DATA/xqp/my02/ergs/accuracyf10/' accuracy4 '.mat'];
            ...
            savepathsort5 = ['/DATA/xqp/my02/ergs/accuracyf10/' accuracy5 '.mat'];
            ...
            savepathsort6 = ['/DATA/xqp/my02/ergs/accuracyf10/' accuracy6 '.mat'];
            ...
            savepathsort7 = ['/DATA/xqp/my02/ergs/accuracyf10/' accuracy7 '.mat'];
            ...
            savepathsort8 = ['/DATA/xqp/my02/ergs/accuracyf10/' accuracy8 '.mat'];
            ...
            savepathsort9 = ['/DATA/xqp/my02/ergs/accuracyf10/' accuracy9 '.mat'];
            ...
            [accuracy_KJH_GBDT,precision_KJH_cotton,precision_KJH_Denim,precision_KJH_Fleece,precision_KJH_Nylon,precision_KJH_Polyester,precision_KJH_silk,precision_KJH_Terrycloth,precision_KJH_Viscose,precision_KJH_Wool]=softmian(label,agg_score);
            eval([accuracy10 '=accuracy_KJH_GBDT;']);
            eval([cotton10 '=precision_KJH_cotton;']);
            eval([Denim10 '=precision_KJH_Denim;']);
            eval([Fleece10 '=precision_KJH_Fleece;']);
            eval([Nylon10 '=precision_KJH_Nylon;']);
            eval([Polyester10 '=precision_KJH_Polyester;']);
            eval([silk10 '=precision_KJH_silk;']);
            eval([Terrycloth10 '=precision_KJH_Terrycloth;']);
            eval([Viscose10 '=precision_KJH_Viscose;']);
            eval([Wool10 '=precision_KJH_Wool;']);
            savepathsort10 = ['/DATA/xqp/my02/ergs/accuracyf10/' accuracy10 '.mat'];
            fprintf("save path sort10 : %s\n",savepathsort10);
            save(savepathsort10,accuracy10,cotton10,Denim10,Fleece10,Nylon10,Polyester10,silk10,Terrycloth10,Viscose10,Wool10);
...
%                 sumxx = ['sum'];
            ...
            eval([w9 '=w_B;']);
            eval([w10 '=w_O;']);
            savepathsum = ['/DATA/xqp/my02/ergs/fusionf10/' sumall '.mat'];
            fprintf("save path sum : %s\n",savepathsum);
            save(savepathsum,sumall,w1,w2,w3,w4,w5,w6,w7,w8,w9,w10);
...
%                save('../fusionf/accuracy_GS_GBDT.mat','accuracy_GS_GBDT','precision_GS_cotton','precision_GS_Denim','precision_GS_Fleece','precision_GS_Nylon','precision_GS_Polyester','precision_GS_silk','precision_GS_Terrycloth','precision_GS_Viscose','precision_GS_Wool')
            ...
            savepathall = ['/DATA/xqp/my02/ergs/fusionf10/' accuracy_all '.mat'];
...
%                save('../accuracyf/accuracy_SIFT_GBDT.mat','accuracy_SIFT_GBDT','precision_SIFT_cotton','precision_SIFT_Denim','precision_SIFT_Fleece','precision_SIFT_Nylon','precision_SIFT_Polyester','precision_SIFT_silk','precision_SIFT_Terrycloth','precision_SIFT_Viscose','precision_SIFT_Wool');
        ...
        save('/DATA/xqp/my02/ergs/fusionf10/list.mat','fused');
    end
    avgxx = ['avg_' num2str(ggg)];
    eval([avgxx '=avgoo';]);
    saveppp = ['/DATA/xqp/my02/ergs/fusionf10/' 'accuracy_esm' '_' num2str(ggg) '.mat'];
    save(saveppp,avgxx);
